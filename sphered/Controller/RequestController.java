...
public class RequestController {
    ...
    public Request createDraft(
        ...
        return requestService.createDraftRequest(userId, itemType, requestedDate);
    }
    ...
    // Consolidated Stats API including Rejected requests
    // Ensure this is the ONLY getStats method in the file
    @GetMapping("/stats")
    ...
    public ResponseEntity<Page<Request>> getQueueRequests(
        ...
        return ResponseEntity.ok(
                requestService.getQueueRequests(page, size)
        );
    ...
    public ResponseEntity<Page<Request>> getHistoryRequests(
        ...
        return ResponseEntity.ok(
                requestService.getHistoryRequests(page, size)
        );
